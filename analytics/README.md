...
Accounts can be created in many different ways (direct call to create account, first nxBTC receipt, first signature, etc).

We define new accounts as addresses that received nxBTC for the first time.
